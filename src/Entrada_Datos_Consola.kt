fun main() {
    ...
    // .toInt() convierte los datos de entadra a tipo numerico
    ...
    print("El producto de $valor1 * $valor2 es $producto")
 ...
 */
   ...
   print("Ingrese el valor del lado del cuadrado:")
    ...
    println("El perimetro de este cuadrado es $perimetro")
 ...
 */
    ...
    println("El resultado de la suma de los dos primeros numeros es $suma")
    val producto = tercer * cuarto
